On June 7, 2024, two workers at Honeywell's Geismar, Louisiana plant opened a flanged connection to swap out a gasket. A flange is just a bolted joint between two pipe sections; the gasket is the seal between them. One of the two workers was a contractor. They had a permit. They had done this job before. The line was supposed to be empty.

It was not. Less than a pound of anhydrous hydrogen fluoride — HF — was still inside. When the flange came apart, that HF found the contractor's face. He spent two days in a hospital with second-degree burns.

Less than a pound. And here is the part that should make you sit up: that was the *small* one. The U.S. Chemical Safety Board investigated three separate HF releases at this single site over a stretch of under three years.

*Image: PilMo Kang on Unsplash.*

The CSB's final report on the Honeywell Geismar hydrogen fluoride incidents came out May 27, 2025, and it walks through all three. The headline finding is the kind of sentence that should stop a turnaround planner cold. Every one of these releases, the Board concluded, was preventable — using systems the company already had on paper. CSB Chairperson Steve Owens put it plainly: "Not only were these three serious incidents completely unacceptable, our investigation found that they also were entirely preventable."
...
If you have never worked an HF unit, give the chemistry thirty seconds. It explains why "a small leak" is not a small problem.

Anhydrous HF boils at about 19.5 °C (67 °F). That is room temperature. So a release does not pool on the deck the way a heavy oil would — it flashes into a vapor cloud and rides the wind. That is exactly why the January 2023 release at Geismar (more on it below) sent neighboring facilities into shelter-in-place.

On skin, HF does not behave like a normal acid. Technically it is a *weak* acid — and that is precisely what makes it dangerous. It soaks through intact skin before your nerves feel much pain. Then, deep in the tissue, it breaks apart into fluoride ions. Those ions grab the calcium and magnesium your cells need to function. The result is tissue that dies and liquefies from the inside out. And for a burn of any real size, the body can drop so low on calcium — systemic hypocalcemia — that it can stop a heart.

The medical literature flags burns larger than about 160 cm² (25 square inches) as a serious systemic-toxicity risk. The pain is treacherous, too: at concentrations at or below 20%, you might not feel it for up to 24 hours. A worker can get splashed, feel almost nothing, drive home, and then fall apart overnight.

The antidote is calcium gluconate — a gel you massage into the skin until the pain stops, plus IV calcium for systemic exposure. If your HF site does not have it staged right at the unit and in the medical bay, that is a gap, full stop. None of this is exotic knowledge inside an HF unit. The point is simply what it costs when a "cleared" line turns out not to be.
...
One fatality. One serious injury. Roughly $18 million in damage. Three different failure modes — a gasket, a vessel, a line isolation. And a single conclusion ties them all together. The CSB found that "all three incidents resulted from the ineffective implementation of Honeywell's existing safety management systems. Had Honeywell followed its existing normal procedures, policies, and practices, it could have, and likely would have, prevented each of the three incidents."

Read that twice. The problem was not that they lacked a procedure. The problem was the gap between the procedure on the shelf and the work at the flange. And that gap is where contractors live.

## The 2007 decision that set the table

The October 2021 fatality did not start in 2021. It started in 2007.

That year, Honeywell identified a new gasket technology for the HF service and ran a Management of Change analysis on it — the formal review you do before changing equipment or a procedure. The engineering recognized the corrosion problem. The fix existed. And then the company made a decision that sounds reasonable in a budget meeting and is lethal on a fourteen-year horizon. Rather than proactively replacing the gaskets across the whole unit, it would replace them **by attrition** — swap each one out only when it happened to come apart for some other reason.

"By attrition" is a quiet phrase. Here is what it means in practice. A gasket flagged as a corrosion risk stays in service — holding back a chemical that flashes to vapor at room temperature — until something else gives you a reason to open that specific flange. The gasket that failed in October 2021 was still in the unit fourteen years after the better option was identified. It had simply never been *its turn*.

The CSB also found that inspectors at the site "did not use available technologies" that would have caught the deterioration earlier — including HF atmospheric monitors and acid-indicating paint, which changes color wherever HF is weeping. The tools to see the problem existed. They were just not being used.

![Close-up of a corroded industrial pipe and vent fitting, the kind of weathered connection that hides wall loss and weeping until a flange is opened.](/images/blog/geismar-hydrogen-fluoride-gasket-csb/mid.jpg)

*Image: Eric Prouzet on Unsplash.*

This is the part that should land for anyone who has ever stood at a manway with a torque wrench. Mechanical integrity failures rarely announce themselves. A gasket "managed by attrition" looks exactly like a gasket that is fine — right up until you break the joint. The crew on a line never gets to see the 2007 MoC analysis. They just inherit its consequences.

## The engineer who left in April 2022

The January 2023 reboiler rupture has a different shape. And it is the one the CSB pushed hardest on — all the way up to recommending that OSHA change a federal regulation.
...
Honeywell had a system for exactly this. It is called Management of Organizational Change. The idea is simple: when a person leaves or a role gets restructured, you ask *what did they know that the next person needs to know, and what were they holding that now has no owner?* The system existed. It just was not applied to the departure.
...
Now back to the contractor. His incident is the one a crew lead can do the most about.

Walk it from his side of the flange. He has a permit. On paper, the line has been isolated and drained. He is replacing a gasket — routine maintenance, the most ordinary task on an HF unit, the kind of job that fills a turnaround punch list. He breaks the joint expecting nothing, because nothing is what the permit promised. And the connection "was not adequately emptied of HF" — so a residual amount, less than a pound, sprays his face.

The training card covers the visible hazards. It tells you HF is dangerous, tells you the PPE, tells you the antidote. What the card does not cover is the gap between two statements. One is "the line has been isolated and drained" — a checkbox. The other is "I have personally verified this specific joint is empty and depressurized" — a physical fact. Those are not the same statement. The first is a status someone upstream asserted. The second is something you confirm at the steel, with your own monitor, before the last bolts come off.

Residual HF in a drained line is not a freak event. Low points trap liquid. Dead legs — sections of pipe with no flow through them — hold inventory a bulk drain never touches. A line can read "drained" at the operations panel and still have a pocket of HF waiting at the exact flange you are about to open. The standard procedure for line-breaking on toxic service exists for precisely this reason: "we drained it" is not proof that *this joint* is clear.
...
```mermaid
sequenceDiagram
    participant Ops as Operations (isolation owner)
    participant PTW as Permit issuer
    participant Lead as Entry / break lead
    participant Crew as Crew at the flange
    Ops->>PTW: Line isolated, drained, depressured
    PTW->>Lead: Permit issued
    Lead->>Crew: Brief, PPE, antidote staged
    Crew->>Crew: Independent check — monitor at the joint, crack & verify zero
    Crew-->>Lead: STOP if any reading, pressure, or doubt
    Crew->>Crew: Break joint only after own verification
```
...
Roughly 42 U.S. refineries ran HF alkylation as of late 2024 — about a third of the operating fleet. In an HF alky unit, hydrofluoric acid is the *catalyst*: it drives the reaction that turns light olefins into high-octane blendstock. And because it is a catalyst, it is not used up — it circulates, in large inventory, indefinitely. The documented period of greatest exposure potential is not normal running. It is **equipment maintenance**. Which is to say: turnarounds. Which is to say: contractor crews.

That is the whole reason a report about a Louisiana refrigerant plant belongs on a contractor's blog. Every one of the three Geismar failure modes has a turnaround twin:
